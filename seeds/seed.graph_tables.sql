...
VALUES
    ...
    ('4', 'MSLCRS(SOLO)', 'Dancer (soloist) starts downstage in the chair facing upstage with a large mirror covering the back sham');

INSERT INTO assignedPieces (id, title, piece)
VALUES
    ('1', 'GrapherOne', '2112'),
    ('2', 'GrapherTwo', 'Baired'),
    ('3', 'GrapherThree','2112'),
...
INSERT INTO graphUsers (id, title, piece)
VALUES
    ('1', 'GrapherOne'),
    ('2', 'GrapherTwo'),
    ('3', 'GrapherThree'),
